    ...
    public class AuthServices : IAuthServices
    {
        ...
        public async Task<AuthModel> RegisterAsync(RegisterModel model)
        {
            ...
            return new AuthModel
            {
                ...
                Message="Created Susessfully"
            };
        }


        public async Task<AuthModel> SignInAsync(SignInModel model)
        {
        ...
        public async Task<string> CreateRoleAsync(AddRoleModel model)
        {
            ...
            return result.Succeeded ? string.Empty : "Failed to create role";
        }

        public async Task<string> AddRoleAsync(AssignRoleModel model)
        {
        ...
        private async Task<JwtSecurityToken> CreateJwtToken(ApplicationUser user)
        {
            ...
            var symmetricSecurityKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_jwt.SecurityKey));
